...
public class PgpDecryptor extends PgpBase {

    private final char[] passCode;
    private final PGPSecretKeyRingCollection pgpSecretKeyRingCollection;

    public PgpDecryptor(InputStream privateKeyIn, String passCode) throws IOException, PGPException {
    ...
    public PgpDecryptor(String privateKeyStr, String passCode) throws IOException, PGPException {
    ...
    public void decrypt(OutputStream clearOut, PGPPrivateKey pgpPrivateKey, PGPPublicKeyEncryptedData publicKeyEncryptedData) throws IOException, PGPException {
